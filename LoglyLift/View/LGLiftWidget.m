                  ...
                  cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
        ...
        !self.loadingImageTasks[@(indexPath.item)] )
    {
        ...
        NSString *correctString = [NSString stringWithCString:[item.title cStringUsingEncoding:NSISOLatin1StringEncoding] encoding:NSUTF8StringEncoding];
        ...
        if (item.isArticle.longValue == 0 && item.advertisingSubject != nil) {
            ...
            cell.subtextLabel.font = [cell.subtextLabel.font fontWithSize: (12.0f * sw/320.0f)];
        }
